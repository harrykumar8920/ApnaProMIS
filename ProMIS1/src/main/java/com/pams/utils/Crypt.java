...
public class Crypt {
	...
	/*public static void main(String a[]) throws Exception {
		 ...
		 *
		 * private static final byte[] secretKey = new byte[] { ‘m’, ‘u’, ‘s’,
		 * ‘t’, ‘b’, ‘e’, ‘1’, ‘6’, ‘b’, ‘y’, ‘t’,’e’, ‘s’, ‘k’, ‘e’, ‘y’};
		 *
		 * below is the direct 16byte string we can use
		 
		String secretKey = "mustbe16byteskey";
		String encodedBase64Key = encodeKey(secretKey);
		System.out.println("EncodedBase64Key =" + encodedBase64Key); // This
																		// need
																		// to be
																		// share
																		// between
		...
		String decrStr = Crypt.decrypt("KLeNFv/QkanM0xDGLESIMQ==", encodedBase64Key);
